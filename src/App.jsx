...
function ProductCard(props) {
  const { name, description, price, imageUrl, inStock, rating } = props;
  ...
  return (
    <div style={styles.card}>
      <div style={styles.imageWrapper}>
        {!inStock && (
          <span style={{ ...styles.badge, ...styles.badgeOut }}>
            Out of stock
          </span>
        )}
        {inStock && (
          <span style={{ ...styles.badge, ...styles.badgeIn }}>
            In stock
          </span>
        )}
        {price < 500 && (
...
const styles = {
  ...
  badgeIn: { background: "#16a34a" },
  badgeOut: { background: "#dc2626" },
  badgeSale: {
    top: 10,
    right: 10,
    left: "auto",
